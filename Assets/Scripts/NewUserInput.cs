...
public class NewUserInput : MonoBehaviour
{
    ...
    public void iUpdate()
    {
        ...
        i++;
        using (StreamWriter sr = new StreamWriter(Application.persistentDataPath + "/financialTest.txt"))
        {
        ...
        if(i==6)
        {
           // user.setYearlySavings(float.Parse(userInfo[6]));
            ...
            //StreamWriter sr = new StreamWriter(Application.persistentDataPath + "/financialTest.txt");
            //sr.WriteLine(user.getUserName());
            //sr.Close();
            //icheck.text = i + userInfo[i];
        }
    ...
    public void WriteToFile()
    {
        ...
        string FILE_PATH = Application.persistentDataPath + "/finTest.txt";
